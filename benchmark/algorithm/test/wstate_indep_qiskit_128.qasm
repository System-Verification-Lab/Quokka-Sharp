...
s q[117];
h q[117];
rz(1.47899759999919) q[117];
h q[117];
sdg q[117];
s q[118];
h q[118];
rz(1.479381968422849) q[118];
h q[118];
sdg q[118];
s q[119];
h q[119];
rz(1.4797615487574816) q[119];
h q[119];
sdg q[119];
s q[120];
h q[120];
rz(1.4801364395941514) q[120];
h q[120];
sdg q[120];
s q[121];
h q[121];
rz(1.480506736705006) q[121];
h q[121];
sdg q[121];
s q[122];
h q[122];
rz(1.4808725331460622) q[122];
h q[122];
sdg q[122];
s q[123];
h q[123];
rz(1.4812339193554516) q[123];
h q[123];
sdg q[123];
s q[124];
h q[124];
rz(1.4815909832473548) q[124];
h q[124];
sdg q[124];
s q[125];
h q[125];
rz(1.4819438103018496) q[125];
h q[125];
sdg q[125];
s q[126];
h q[126];
rz(1.482292483650881) q[126];
h q[126];
sdg q[126];
x q[127];
h q[126];
