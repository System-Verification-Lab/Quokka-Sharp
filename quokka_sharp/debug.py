...
# sol = sy.solveset(sy.Eq(sy.cos(theta), 1), theta, domain=sy.S.Reals)
# print(sol)
...
#outputs = [2]
outputs = None
res = qk.CheckEquivalence(cnf, check = "linear", outputs = outputs, N=1, cnf_file_root=cnf_dir)
