...
def main():
    ...
    print("        cnf.add_weight(x[k], frac1sqrt2, frac1sqrt2)")
    print()
    add_sign(x[k] & X)
    print()
    ...
    print("        x = cnf.vars.x")
    print("        cnf.add_weight(x[k], complex(Decimal(math.cos(theta)), Decimal(math.sin(theta))), 1)")
    print()
    ...
    print("        cnf.add_weight(w, complex(Decimal(math.cos(theta/2)), 0), complex(0, -Decimal(math.sin(theta/2))))")
    print()
    print("        cnf.vars.x[k] = X")
    print()
